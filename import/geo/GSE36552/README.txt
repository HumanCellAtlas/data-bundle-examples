Downloaded sra format DNA files with
	lftp  -c "mirror -P 20  ftp://ftp-trace.ncbi.nih.gov/sra/sra-instant/reads/ByStudy/sra/SRP/SRP011/SRP011546/ sra"
	chmod u+w sra/SRR* sra/SRR/*
Run parasol job to convert .sra files to .fastq.gz's

Downloaded soft file from NCBI web site to GSE36552_family.soft and convert to 
	geoToTagStorm *_family.soft geo.tags 
Edit out data's exome

Download SraRunTable.txt by going to https://www.ncbi.nlm.nih.gov/sra?term=SRP011546 and selecting "send to" "Run Selector"
